...
19 & Provide data and code or state where they can be accessed. & Data Availability; submission supplementary data; \textbf{Partial pending public deposit}. & Public source URLs and eQTL Catalogue dataset identifiers are provided. Corrected scripts and machine-readable results accompany the submission. SHA-256 checksums for the seven core GTEx/FinnGen raw inputs and audit outputs are included in the draft public archive. A versioned GitHub/Zenodo deposit will be completed by the authors before publication and the final DOI/URL inserted when available. \\
