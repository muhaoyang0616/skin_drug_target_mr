...
19 & Provide data and code or state where they can be accessed. & Data Availability; submission supplementary data; \textbf{Complete}. & Public source URLs and eQTL Catalogue dataset identifiers are provided. Corrected scripts and machine-readable results accompany the submission and are deposited in the versioned public archive at \href{https://github.com/muhaoyang0616/skin_drug_target_mr/releases/tag/v1.0.0}{GitHub release v1.0.0} (Zenodo DOI \href{https://doi.org/10.5281/zenodo.21331678}{10.5281/zenodo.21331678}). SHA-256 checksums for the seven core GTEx/FinnGen raw inputs and audit outputs are included in the public archive. \\
